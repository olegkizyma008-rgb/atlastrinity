...
export async function requestPermissions(): Promise<void> {
    ...
    if (!status.accessibility) {
        const result = await dialog.showMessageBox({
            ...
            detail: 'Натисніть "Відкрити налаштування" і додайте AtlasTrinity до списку дозволених додатків.',
 ...
 */
export async function openSystemPreferences(pane: 'accessibility' | 'microphone' | 'screen'): Promise<void> {
