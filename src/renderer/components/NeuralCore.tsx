      ...
      <svg viewBox="-400 -400 800 800" className="orbital-svg">
        ...
        <g transform="rotate(0)">
          ...
          <circle
            ...
            r={isAtlas ? 12 : 6}
            fill="var(--atlas-blue)"
            className={isAtlas ? 'glow-md animate-pulse' : ''}
            opacity={isAtlas ? 1 : 0.5}
          />
          <text
            x="0"
            y="-210"
        ...
        <g transform="rotate(120)">
          <line
            ...
            x2="0"
            y2="-170"
            stroke="var(--grisha-orange, #FF8000)"
            strokeWidth="1"
            opacity={isGrisha ? 0.8 : 0.2}
          />
          {/* Rotate text back to be upright */}
          <g transform="translate(0, -180)">
            <circle
              r={isGrisha ? 12 : 6}
              fill="var(--grisha-orange, #FF8000)"
              transform="rotate(-120)"
              className={isGrisha ? 'glow-md animate-pulse' : ''}
              opacity={isGrisha ? 1 : 0.5}
            />
            <text
              y="30"
              transform="rotate(-120)"
        ...
        <g transform="rotate(240)">
          ...
          <g transform="translate(0, -180)">
            <circle
              ...
              className={isTetyana ? 'glow-md animate-pulse' : ''}
              opacity={isTetyana ? 1 : 0.5}
            />
            <text
              y="30"
              transform="rotate(-240)"
